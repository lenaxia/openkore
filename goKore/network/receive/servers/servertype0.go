...
func ServerType0PacketConstructions() map[string]common.PacketConstruction {
	...
	packets["0069"] = common.PacketConstruction{
		ID:         "0069",
	...
	packets["006A"] = common.PacketConstruction{
		ID:         "006A",
		Name:       "login_error",
		Format:     "C Z20",
	...
	packets["0073"] = common.PacketConstruction{
		ID:         "0073",
		Name:       "map_loaded",
		Format:     "V a3 C2",
	...
	packets["01D8"] = common.PacketConstruction{
		ID:         "01D8",
		Name:       "actor_exists",
		Format:     "a4 v14 a4 a2 v2 C2 a3 C3 v",
	...
	packets["01D9"] = common.PacketConstruction{
		ID:         "01D9",
		Name:       "actor_connected",
		Format:     "a4 v14 a4 a2 v2 C2 a3 C2 v",
	...
	packets["01DA"] = common.PacketConstruction{
		ID:         "01DA",
		Name:       "actor_moved",
	...
	packets["01DC"] = common.PacketConstruction{
		ID:         "01DC",
		Name:       "secure_login_key",
		Format:     "x2 a*",
		FieldNames: []string{"secure_key"},
	}
	packets["01DE"] = common.PacketConstruction{
		ID:         "01DE",
		Name:       "skill_use",
		Format:     "v a4 a4 V4 v2 C",
		FieldNames: []string{"skillID", "sourceID", "targetID", "tick", "src_speed", "dst_speed", "damage", "level", "option", "type"},
	}
	packets["01E0"] = common.PacketConstruction{
		ID:         "01E0",
		Name:       "GM_req_acc_name",
		Format:     "a4 Z24",
		FieldNames: []string{"targetID", "accountName"},
	}
	packets["01E1"] = common.PacketConstruction{
		ID:         "01E1",
		Name:       "revolving_entity",
		Format:     "a4 v",
		FieldNames: []string{"sourceID", "entity"},
	}
	packets["01E2"] = common.PacketConstruction{
		ID:         "01E2",
		Name:       "marriage_unknown",
		Format:     "",
		FieldNames: []string{},
	}
	packets["01E4"] = common.PacketConstruction{
		ID:         "01E4",
		Name:       "marriage_unknown",
		Format:     "",
		FieldNames: []string{},
	}
	packets["01E6"] = common.PacketConstruction{
		ID:         "01E6",
		Name:       "marriage_partner_name",
		Format:     "Z24",
		FieldNames: []string{"name"},
	}
	packets["01E9"] = common.PacketConstruction{
		ID:         "01E9",
		Name:       "party_join",
		Format:     "a4 V v2 C Z24 Z24 Z16 v C2",
		FieldNames: []string{"ID", "role", "x", "y", "type", "name", "user", "map", "lv", "item_pickup", "item_share"},
	}
	packets["01EA"] = common.PacketConstruction{
		ID:         "01EA",
		Name:       "married",
		Format:     "a4",
		FieldNames: []string{"ID"},
	}
	packets["01EB"] = common.PacketConstruction{
		ID:         "01EB",
		Name:       "guild_location",
		Format:     "a4 v2",
		FieldNames: []string{"ID", "x", "y"},
	}
	packets["01EC"] = common.PacketConstruction{
		ID:         "01EC",
		Name:       "guild_member_map_change",
		Format:     "a4 a4 Z16",
		FieldNames: []string{"charID", "ID", "mapName"},
	}
	packets["01EE"] = common.PacketConstruction{
		ID:         "01EE",
		Name:       "inventory_items_stackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["01EF"] = common.PacketConstruction{
		ID:         "01EF",
		Name:       "cart_items_stackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["01F0"] = common.PacketConstruction{
		ID:         "01F0",
		Name:       "storage_items_stackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["01F2"] = common.PacketConstruction{
		ID:         "01F2",
		Name:       "guild_member_online_status",
		Format:     "a4 a4 V v3",
		FieldNames: []string{"ID", "charID", "online", "sex", "hair_style", "hair_color"},
	}
	packets["01F3"] = common.PacketConstruction{
		ID:         "01F3",
		Name:       "misc_effect",
		Format:     "a4 V",
		FieldNames: []string{"ID", "effect"},
	}
	packets["01F4"] = common.PacketConstruction{
		ID:         "01F4",
		Name:       "deal_request",
		Format:     "Z24 a4 v",
		FieldNames: []string{"user", "ID", "level"},
	}
	packets["01F5"] = common.PacketConstruction{
		ID:         "01F5",
		Name:       "deal_begin",
		Format:     "C a4 v",
		FieldNames: []string{"type", "targetID", "level"},
	}
	packets["01F6"] = common.PacketConstruction{
		ID:         "01F6",
		Name:       "adopt_request",
		Format:     "a4 a4 Z24",
		FieldNames: []string{"sourceID", "targetID", "name"},
	}
	packets["01F8"] = common.PacketConstruction{
		ID:         "01F8",
		Name:       "adopt_unknown",
		Format:     "",
		FieldNames: []string{},
	}
	packets["01FC"] = common.PacketConstruction{
		ID:         "01FC",
		Name:       "repair_list",
		Format:     "",
		FieldNames: []string{},
	}
	packets["01FE"] = common.PacketConstruction{
		ID:         "01FE",
		Name:       "repair_result",
		Format:     "v C",
		FieldNames: []string{"index", "flag"},
	}
	packets["01FF"] = common.PacketConstruction{
		ID:         "01FF",
		Name:       "high_jump",
		Format:     "a4 v2",
		FieldNames: []string{"ID", "x", "y"},
	}
	packets["0201"] = common.PacketConstruction{
		ID:         "0201",
		Name:       "friend_list",
		Format:     "",
		FieldNames: []string{},
	}
	packets["0205"] = common.PacketConstruction{
		ID:         "0205",
		Name:       "divorced",
		Format:     "Z24",
		FieldNames: []string{"name"},
	}
	packets["0206"] = common.PacketConstruction{
		ID:         "0206",
		Name:       "friend_logon",
		Format:     "a4 a4 C",
		FieldNames: []string{"friendAccountID", "friendCharID", "isNotOnline"},
	}
	packets["0207"] = common.PacketConstruction{
		ID:         "0207",
		Name:       "friend_request",
		Format:     "a4 a4 Z24",
		FieldNames: []string{"accountID", "charID", "name"},
	}
	packets["0209"] = common.PacketConstruction{
		ID:         "0209",
		Name:       "friend_response",
		Format:     "v a4 a4 Z24",
		FieldNames: []string{"type", "accountID", "charID", "name"},
	}
	packets["020A"] = common.PacketConstruction{
		ID:         "020A",
		Name:       "friend_removed",
		Format:     "a4 a4",
		FieldNames: []string{"friendAccountID", "friendCharID"},
	}
	packets["020D"] = common.PacketConstruction{
		ID:         "020D",
		Name:       "character_ban_list",
		Format:     "v a*",
		FieldNames: []string{"len", "charList"},
	}
	packets["020E"] = common.PacketConstruction{
		ID:         "020E",
		Name:       "taekwon_packets",
		Format:     "Z24 a4 C2",
		FieldNames: []string{"name", "ID", "value", "flag"},
	}
	packets["020F"] = common.PacketConstruction{
		ID:         "020F",
		Name:       "pvp_point",
		Format:     "V2",
		FieldNames: []string{"AID", "GID"},
	}
	packets["0215"] = common.PacketConstruction{
		ID:         "0215",
		Name:       "gospel_buff_aligned",
		Format:     "a4",
		FieldNames: []string{"ID"},
	}
	packets["0216"] = common.PacketConstruction{
		ID:         "0216",
		Name:       "adopt_reply",
		Format:     "V",
		FieldNames: []string{"type"},
	}
	packets["0219"] = common.PacketConstruction{
		ID:         "0219",
		Name:       "top10_blacksmith_rank",
		Format:     "",
		FieldNames: []string{},
	}
	packets["021A"] = common.PacketConstruction{
		ID:         "021A",
		Name:       "top10_alchemist_rank",
		Format:     "",
		FieldNames: []string{},
	}
	packets["021B"] = common.PacketConstruction{
		ID:         "021B",
		Name:       "blacksmith_points",
		Format:     "V2",
		FieldNames: []string{"points", "total"},
	}
	packets["021C"] = common.PacketConstruction{
		ID:         "021C",
		Name:       "alchemist_point",
		Format:     "V2",
		FieldNames: []string{"points", "total"},
	}
	packets["0221"] = common.PacketConstruction{
		ID:         "0221",
		Name:       "upgrade_list",
		Format:     "v a*",
		FieldNames: []string{"len", "item_list"},
	}
	packets["0223"] = common.PacketConstruction{
		ID:         "0223",
		Name:       "upgrade_message",
		Format:     "V v",
		FieldNames: []string{"type", "itemID"},
	}
	packets["0224"] = common.PacketConstruction{
		ID:         "0224",
		Name:       "taekwon_rank",
		Format:     "V2",
		FieldNames: []string{"type", "rank"},
	}
	packets["0226"] = common.PacketConstruction{
		ID:         "0226",
		Name:       "top10_taekwon_rank",
		Format:     "",
		FieldNames: []string{},
	}
	packets["0227"] = common.PacketConstruction{
		ID:         "0227",
		Name:       "gameguard_request",
		Format:     "",
		FieldNames: []string{},
	}
	packets["0229"] = common.PacketConstruction{
		ID:         "0229",
		Name:       "character_status",
		Format:     "a4 v2 V C",
		FieldNames: []string{"ID", "opt1", "opt2", "option", "stance"},
	}
	packets["022A"] = common.PacketConstruction{
		ID:         "022A",
		Name:       "actor_exists",
		Format:     "a4 v3 V v10 a4 a2 v V C2 a3 C3 v",
		FieldNames: []string{"ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "unknown1", "unknown2", "act", "lv"},
	}
	packets["022B"] = common.PacketConstruction{
		ID:         "022B",
		Name:       "actor_connected",
		Format:     "a4 v3 V v10 a4 a2 v V C2 a3 C2 v",
		FieldNames: []string{"ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "unknown1", "unknown2", "lv"},
	}
	packets["022C"] = common.PacketConstruction{
		ID:         "022C",
		Name:       "actor_moved",
		Format:     "a4 v3 V v5 V v5 a4 a2 v V C2 a6 C2 v",
		FieldNames: []string{"ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tick", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "unknown1", "unknown2", "lv"},
	}
	packets["0230"] = common.PacketConstruction{
		ID:         "0230",
		Name:       "homunculus_info",
		Format:     "C2 a4 V",
		FieldNames: []string{"type", "state", "ID", "val"},
	}
	packets["0235"] = common.PacketConstruction{
		ID:         "0235",
		Name:       "skills_list",
		Format:     "",
		FieldNames: []string{},
	}
	packets["0238"] = common.PacketConstruction{
		ID:         "0238",
		Name:       "top10_pk_rank",
		Format:     "",
		FieldNames: []string{},
	}
	packets["0239"] = common.PacketConstruction{
		ID:         "0239",
		Name:       "skill_update",
		Format:     "v4 C",
		FieldNames: []string{"skillID", "lv", "sp", "range", "up"},
	}
	packets["023A"] = common.PacketConstruction{
		ID:         "023A",
		Name:       "storage_password_request",
		Format:     "v",
		FieldNames: []string{"flag"},
	}
	packets["023C"] = common.PacketConstruction{
		ID:         "023C",
		Name:       "storage_password_result",
		Format:     "v2",
		FieldNames: []string{"type", "val"},
	}
	packets["023E"] = common.PacketConstruction{
		ID:         "023E",
		Name:       "storage_password_request",
		Format:     "v",
		FieldNames: []string{"flag"},
	}
	packets["0240"] = common.PacketConstruction{
		ID:         "0240",
		Name:       "mail_refreshinbox",
		Format:     "v V",
		FieldNames: []string{"size", "count"},
	}
	packets["0242"] = common.PacketConstruction{
		ID:         "0242",
		Name:       "mail_read",
		Format:     "v V Z40 Z24 V3 v2 C3 a8 C Z*",
		FieldNames: []string{"len", "mailID", "title", "sender", "delete_time", "zeny", "amount", "nameID", "type", "identified", "broken", "upgrade", "cards", "msg_len", "message"},
	}
	packets["0245"] = common.PacketConstruction{
		ID:         "0245",
		Name:       "mail_getattachment",
		Format:     "C",
		FieldNames: []string{"fail"},
	}
	packets["0249"] = common.PacketConstruction{
		ID:         "0249",
		Name:       "mail_send",
		Format:     "C",
		FieldNames: []string{"fail"},
	}
	packets["024A"] = common.PacketConstruction{
		ID:         "024A",
		Name:       "mail_new",
		Format:     "V Z40 Z24",
		FieldNames: []string{"mailID", "title", "sender"},
	}
	packets["0250"] = common.PacketConstruction{
		ID:         "0250",
		Name:       "auction_result",
		Format:     "C",
		FieldNames: []string{"flag"},
	}
	packets["0252"] = common.PacketConstruction{
		ID:         "0252",
		Name:       "auction_item_request_search",
		Format:     "v V2",
		FieldNames: []string{"size", "pages", "count"},
	}
	packets["0253"] = common.PacketConstruction{
		ID:         "0253",
		Name:       "starplace",
		Format:     "C",
		FieldNames: []string{"which"},
	}
	packets["0255"] = common.PacketConstruction{
		ID:         "0255",
		Name:       "mail_setattachment",
		Format:     "a2 C",
		FieldNames: []string{"ID", "fail"},
	}
	packets["0256"] = common.PacketConstruction{
		ID:         "0256",
		Name:       "auction_add_item",
		Format:     "a2 C",
		FieldNames: []string{"ID", "fail"},
	}
	packets["0257"] = common.PacketConstruction{
		ID:         "0257",
		Name:       "mail_delete",
		Format:     "V v",
		FieldNames: []string{"mailID", "fail"},
	}
	packets["0259"] = common.PacketConstruction{
		ID:         "0259",
		Name:       "gameguard_grant",
		Format:     "C",
		FieldNames: []string{"server"},
	}
	packets["025A"] = common.PacketConstruction{
		ID:         "025A",
		Name:       "cooking_list",
		Format:     "v2 a*",
		FieldNames: []string{"len", "type", "item_list"},
	}
	packets["025D"] = common.PacketConstruction{
		ID:         "025D",
		Name:       "auction_my_sell_stop",
		Format:     "V",
		FieldNames: []string{"flag"},
	}
	packets["025F"] = common.PacketConstruction{
		ID:         "025F",
		Name:       "auction_windows",
		Format:     "V C4 v",
		FieldNames: []string{"flag", "unknown1", "unknown2", "unknown3", "unknown4", "unknown5"},
	}
	packets["0260"] = common.PacketConstruction{
		ID:         "0260",
		Name:       "mail_window",
		Format:     "v",
		FieldNames: []string{"flag"},
	}
	packets["0274"] = common.PacketConstruction{
		ID:         "0274",
		Name:       "account_server_info",
		Format:     "x2 a4 a4 a4 x30 C1 x4 a*",
		FieldNames: []string{"sessionID", "accountID", "sessionID2", "accountSex", "serverInfo"},
	}
	packets["0276"] = common.PacketConstruction{
		ID:         "0276",
		Name:       "account_server_info",
		Format:     "v a4 a4 a4 a4 Z26 C V a*",
		FieldNames: []string{"len", "sessionID", "accountID", "sessionID2", "lastLoginIP", "lastLoginTime", "accountSex", "iAccountSID", "serverInfo"},
	}
	packets["027B"] = common.PacketConstruction{
		ID:         "027B",
		Name:       "premium_rates_info",
		Format:     "V3",
		FieldNames: []string{"exp", "death", "drop"},
	}
	packets["0283"] = common.PacketConstruction{
		ID:         "0283",
		Name:       "account_id",
		Format:     "a4",
		FieldNames: []string{"accountID"},
	}
	packets["0284"] = common.PacketConstruction{
		ID:         "0284",
		Name:       "GANSI_RANK",
		Format:     "c24 c24 c24 c24 c24 c24 c24 c24 c24 c24 V10 v",
		FieldNames: []string{"name1", "name2", "name3", "name4", "name5", "name6", "name7", "name8", "name9", "name10", "pt1", "pt2", "pt3", "pt4", "pt5", "pt6", "pt7", "pt8", "pt9", "pt10", "switch"},
	}
	packets["0287"] = common.PacketConstruction{
		ID:         "0287",
		Name:       "cash_dealer",
		Format:     "v V a*",
		FieldNames: []string{"len", "cash_points", "item_list"},
	}
	packets["0289"] = common.PacketConstruction{
		ID:         "0289",
		Name:       "cash_buy_fail",
		Format:     "V2 v",
		FieldNames: []string{"cash_points", "kafra_points", "fail"},
	}
	packets["028A"] = common.PacketConstruction{
		ID:         "028A",
		Name:       "character_status",
		Format:     "a4 V3",
		FieldNames: []string{"ID", "option", "lv", "opt3"},
	}
	packets["0291"] = common.PacketConstruction{
		ID:         "0291",
		Name:       "message_string",
		Format:     "v",
		FieldNames: []string{"index"},
	}
	packets["0293"] = common.PacketConstruction{
		ID:         "0293",
		Name:       "boss_map_info",
		Format:     "C V2 v2 x4 Z24",
		FieldNames: []string{"flag", "x", "y", "hours", "minutes", "name"},
	}
	packets["0294"] = common.PacketConstruction{
		ID:         "0294",
		Name:       "book_read",
		Format:     "a4 a4",
		FieldNames: []string{"bookID", "page"},
	}
	packets["0295"] = common.PacketConstruction{
		ID:         "0295",
		Name:       "inventory_items_nonstackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["0296"] = common.PacketConstruction{
		ID:         "0296",
		Name:       "storage_items_nonstackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["0297"] = common.PacketConstruction{
		ID:         "0297",
		Name:       "cart_items_nonstackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["0298"] = common.PacketConstruction{
		ID:         "0298",
		Name:       "rental_time",
		Format:     "v V",
		FieldNames: []string{"nameID", "seconds"},
	}
	packets["0299"] = common.PacketConstruction{
		ID:         "0299",
		Name:       "rental_expired",
		Format:     "a2 v",
		FieldNames: []string{"ID", "nameID"},
	}
	packets["029A"] = common.PacketConstruction{
		ID:         "029A",
		Name:       "inventory_item_added",
		Format:     "a2 v2 C3 a8 v C2 a4",
		FieldNames: []string{"ID", "amount", "nameID", "identified", "broken", "upgrade", "cards", "type_equip", "type", "fail", "cards_ext"},
	}
	packets["029D"] = common.PacketConstruction{
		ID:         "029D",
		Name:       "skills_list",
		Format:     "",
		FieldNames: []string{},
	}
	packets["02A2"] = common.PacketConstruction{
		ID:         "02A2",
		Name:       "stat_info",
		Format:     "v V",
		FieldNames: []string{"type", "val"},
	}
	packets["02A6"] = common.PacketConstruction{
		ID:         "02A6",
		Name:       "gameguard_request",
		Format:     "",
		FieldNames: []string{},
	}
	packets["02AA"] = common.PacketConstruction{
		ID:         "02AA",
		Name:       "cash_password_request",
		Format:     "v",
		FieldNames: []string{"info"},
	}
	packets["02AC"] = common.PacketConstruction{
		ID:         "02AC",
		Name:       "cash_password_result",
		Format:     "v2",
		FieldNames: []string{"info", "count"},
	}
	packets["02AD"] = common.PacketConstruction{
		ID:         "02AD",
		Name:       "login_pin_code_request",
		Format:     "v V",
		FieldNames: []string{"flag", "key"},
	}
	packets["02AE"] = common.PacketConstruction{
		ID:         "02AE",
		Name:       "initialize_message_id_encryption",
		Format:     "V2",
		FieldNames: []string{"param1", "param2"},
	}
	packets["02B1"] = common.PacketConstruction{
		ID:         "02B1",
		Name:       "quest_all_list",
		Format:     "v V a*",
		FieldNames: []string{"len", "quest_amount", "message"},
	}
	packets["02B2"] = common.PacketConstruction{
		ID:         "02B2",
		Name:       "quest_all_mission",
		Format:     "v V a*",
		FieldNames: []string{"len", "mission_amount", "message"},
	}
	packets["02B3"] = common.PacketConstruction{
		ID:         "02B3",
		Name:       "quest_add",
		Format:     "V C V2 v a*",
		FieldNames: []string{"questID", "active", "time_start", "time_expire", "mission_amount", "message"},
	}
	packets["02B4"] = common.PacketConstruction{
		ID:         "02B4",
		Name:       "quest_delete",
		Format:     "V",
		FieldNames: []string{"questID"},
	}
	packets["02B5"] = common.PacketConstruction{
		ID:         "02B5",
		Name:       "quest_update_mission_hunt",
		Format:     "v2 a*",
		FieldNames: []string{"len", "mission_amount", "message"},
	}
	packets["02B7"] = common.PacketConstruction{
		ID:         "02B7",
		Name:       "quest_active",
		Format:     "V C",
		FieldNames: []string{"questID", "active"},
	}
	packets["02B8"] = common.PacketConstruction{
		ID:         "02B8",
		Name:       "party_show_picker",
		Format:     "a4 v C3 a8 v C",
		FieldNames: []string{"sourceID", "nameID", "identified", "broken", "upgrade", "cards", "location", "type"},
	}
	packets["02B9"] = common.PacketConstruction{
		ID:         "02B9",
		Name:       "hotkeys",
		Format:     "a*",
		FieldNames: []string{"hotkeys"},
	}
	packets["02C1"] = common.PacketConstruction{
		ID:         "02C1",
		Name:       "npc_chat",
		Format:     "v a4 a4 Z*",
		FieldNames: []string{"len", "ID", "color", "message"},
	}
	packets["02C5"] = common.PacketConstruction{
		ID:         "02C5",
		Name:       "party_invite_result",
		Format:     "Z24 V",
		FieldNames: []string{"name", "type"},
	}
	packets["02C6"] = common.PacketConstruction{
		ID:         "02C6",
		Name:       "party_invite",
		Format:     "a4 Z24",
		FieldNames: []string{"ID", "name"},
	}
	packets["02C9"] = common.PacketConstruction{
		ID:         "02C9",
		Name:       "party_allow_invite",
		Format:     "C",
		FieldNames: []string{"type"},
	}
	packets["02CA"] = common.PacketConstruction{
		ID:         "02CA",
		Name:       "login_error_game_login_server",
		Format:     "C",
		FieldNames: []string{"type"},
	}
	packets["02CB"] = common.PacketConstruction{
		ID:         "02CB",
		Name:       "instance_window_start",
		Format:     "Z61 v",
		FieldNames: []string{"name", "flag"},
	}
	packets["02CC"] = common.PacketConstruction{
		ID:         "02CC",
		Name:       "instance_window_queue",
		Format:     "C",
		FieldNames: []string{"flag"},
	}
	packets["02CD"] = common.PacketConstruction{
		ID:         "02CD",
		Name:       "instance_window_join",
		Format:     "Z61 V2",
		FieldNames: []string{"name", "time_remaining", "time_close"},
	}
	packets["02CE"] = common.PacketConstruction{
		ID:         "02CE",
		Name:       "instance_window_leave",
		Format:     "C",
		FieldNames: []string{"flag"},
	}
	packets["02D0"] = common.PacketConstruction{
		ID:         "02D0",
		Name:       "inventory_items_nonstackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["02D1"] = common.PacketConstruction{
		ID:         "02D1",
		Name:       "storage_items_nonstackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["02D2"] = common.PacketConstruction{
		ID:         "02D2",
		Name:       "cart_items_nonstackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["02D4"] = common.PacketConstruction{
		ID:         "02D4",
		Name:       "inventory_item_added",
	...
	packets["02D5"] = common.PacketConstruction{
		ID:         "02D5",
		Name:       "isvr_disconnect",
		Format:     "",
		FieldNames: []string{},
	}
	packets["02D7"] = common.PacketConstruction{
		ID:         "02D7",
		Name:       "show_eq",
		Format:     "v Z24 v7 C a*",
		FieldNames: []string{"len", "name", "type", "hair_style", "tophead", "midhead", "lowhead", "hair_color", "clothes_color", "sex", "equips_info"},
	}
	packets["02D9"] = common.PacketConstruction{
		ID:         "02D9",
		Name:       "misc_config_reply",
		Format:     "V2",
		FieldNames: []string{"type", "flag"},
	}
	packets["02DA"] = common.PacketConstruction{
		ID:         "02DA",
		Name:       "show_eq_msg_self",
		Format:     "C",
		FieldNames: []string{"type"},
	}
	packets["02DC"] = common.PacketConstruction{
		ID:         "02DC",
		Name:       "battleground_message",
		Format:     "v a4 Z24 Z*",
		FieldNames: []string{"len", "ID", "name", "message"},
	}
	packets["02DD"] = common.PacketConstruction{
		ID:         "02DD",
		Name:       "battleground_emblem",
		Format:     "a4 Z24 v",
		FieldNames: []string{"emblemID", "name", "ID"},
	}
	packets["02DE"] = common.PacketConstruction{
		ID:         "02DE",
		Name:       "battleground_score",
		Format:     "v2",
		FieldNames: []string{"score_lion", "score_eagle"},
	}
	packets["02DF"] = common.PacketConstruction{
		ID:         "02DF",
		Name:       "battleground_position",
		Format:     "a4 Z24 v3",
		FieldNames: []string{"ID", "name", "job", "x", "y"},
	}
	packets["02E0"] = common.PacketConstruction{
		ID:         "02E0",
		Name:       "battleground_hp",
		Format:     "a4 Z24 v2",
		FieldNames: []string{"ID", "name", "hp", "max_hp"},
	}
	packets["02E1"] = common.PacketConstruction{
		ID:         "02E1",
		Name:       "actor_action",
		Format:     "a4 a4 a4 V3 v C V",
		FieldNames: []string{"sourceID", "targetID", "tick", "src_speed", "dst_speed", "damage", "div", "type", "dual_wield_damage"},
	}
	packets["02E7"] = common.PacketConstruction{
		ID:         "02E7",
		Name:       "map_property",
		Format:     "v2 a*",
		FieldNames: []string{"len", "type", "info_table"},
	}
	packets["02E8"] = common.PacketConstruction{
		ID:         "02E8",
		Name:       "inventory_items_stackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["02E9"] = common.PacketConstruction{
		ID:         "02E9",
		Name:       "cart_items_stackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["02EA"] = common.PacketConstruction{
		ID:         "02EA",
		Name:       "storage_items_stackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["02EB"] = common.PacketConstruction{
		ID:         "02EB",
		Name:       "map_loaded",
		Format:     "V a3 a a v",
		FieldNames: []string{"syncMapSync", "coords", "xSize", "ySize", "font"},
	}
	packets["02EC"] = common.PacketConstruction{
		ID:         "02EC",
		Name:       "actor_exists",
		Format:     "x a4 v3 V v5 V v5 a4 a4 V C2 a6 x2 v2",
		FieldNames: []string{"ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tick", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "guildID", "emblemID", "opt3", "stance", "sex", "coords", "lv", "unknown"},
	}
	packets["02ED"] = common.PacketConstruction{
		ID:         "02ED",
		Name:       "actor_connected",
		Format:     "a4 v3 V v10 a4 a4 V C2 a3 v3",
		FieldNames: []string{"ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "guildID", "emblemID", "opt3", "stance", "sex", "coords", "act", "lv", "unknown"},
	}
	packets["02EE"] = common.PacketConstruction{
		ID:         "02EE",
		Name:       "actor_moved",
		Format:     "a4 v3 V v10 a4 a4 V C2 a3 x v3",
		FieldNames: []string{"ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "guildID", "emblemID", "opt3", "stance", "sex", "coords", "act", "lv", "unknown"},
	}
	packets["02EF"] = common.PacketConstruction{
		ID:         "02EF",
		Name:       "font",
		Format:     "a4 v",
		FieldNames: []string{"ID", "fontID"},
	}
	packets["02F0"] = common.PacketConstruction{
		ID:         "02F0",
		Name:       "progress_bar",
		Format:     "V2",
		FieldNames: []string{"color", "time"},
	}
	packets["02F2"] = common.PacketConstruction{
		ID:         "02F2",
		Name:       "progress_bar_stop",
		Format:     "",
		FieldNames: []string{},
	}
	packets["02F7"] = common.PacketConstruction{
		ID:         "02F7",
		Name:       "guild_name",
		Format:     "a4 a4 V C a4 Z24 a4",
		FieldNames: []string{"guildID", "emblemID", "mode", "is_master", "interSID", "guildName", "master_char_id"},
	}
	packets["040C"] = common.PacketConstruction{
		ID:         "040C",
		Name:       "local_broadcast",
		Format:     "v a4 v4 Z*",
		FieldNames: []string{"len", "color", "font_type", "font_size", "font_align", "font_y", "message"},
	}
	packets["043D"] = common.PacketConstruction{
		ID:         "043D",
		Name:       "skill_post_delay",
		Format:     "v V",
		FieldNames: []string{"ID", "time"},
	}
	packets["043E"] = common.PacketConstruction{
		ID:         "043E",
		Name:       "skill_post_delaylist",
		Format:     "v a*",
		FieldNames: []string{"len", "skill_list"},
	}
	packets["043F"] = common.PacketConstruction{
		ID:         "043F",
		Name:       "actor_status_active",
		Format:     "v a4 C V4",
		FieldNames: []string{"type", "ID", "flag", "tick", "unknown1", "unknown2", "unknown3"},
	}
	packets["0440"] = common.PacketConstruction{
		ID:         "0440",
		Name:       "millenium_shield",
		Format:     "a4 v2",
		FieldNames: []string{"ID", "num", "state"},
	}
	packets["0441"] = common.PacketConstruction{
		ID:         "0441",
		Name:       "skill_delete",
		Format:     "v",
		FieldNames: []string{"skillID"},
	}
	packets["0442"] = common.PacketConstruction{
		ID:         "0442",
		Name:       "sage_autospell",
		Format:     "x2 V a*",
		FieldNames: []string{"why", "autoshadowspell_list"},
	}
	packets["0444"] = common.PacketConstruction{
		ID:         "0444",
		Name:       "cash_item_list",
		Format:     "v V3 c v",
		FieldNames: []string{"len", "cash_point", "price", "discount_price", "type", "item_id"},
	}
	packets["0446"] = common.PacketConstruction{
		ID:         "0446",
		Name:       "minimap_indicator",
		Format:     "a4 v4",
		FieldNames: []string{"npcID", "x", "y", "effect", "qtype"},
	}
	packets["0449"] = common.PacketConstruction{
		ID:         "0449",
		Name:       "hack_shield_alarm",
		Format:     "",
		FieldNames: []string{},
	}
	packets["07D8"] = common.PacketConstruction{
		ID:         "07D8",
		Name:       "party_exp",
		Format:     "V C2",
		FieldNames: []string{"type", "itemPickup", "itemDivision"},
	}
	packets["07D9"] = common.PacketConstruction{
		ID:         "07D9",
		Name:       "hotkeys",
		Format:     "a*",
		FieldNames: []string{"hotkeys"},
	}
	packets["07DB"] = common.PacketConstruction{
		ID:         "07DB",
		Name:       "stat_info",
		Format:     "v V",
		FieldNames: []string{"type", "val"},
	}
	packets["07E1"] = common.PacketConstruction{
		ID:         "07E1",
		Name:       "skill_update",
		Format:     "v V v3 C",
		FieldNames: []string{"skillID", "type", "lv", "sp", "range", "up"},
	}
	packets["07E2"] = common.PacketConstruction{
		ID:         "07E2",
		Name:       "message_string",
		Format:     "v V",
		FieldNames: []string{"index", "param"},
	}
	packets["07E3"] = common.PacketConstruction{
		ID:         "07E3",
		Name:       "skill_exchange_item",
		Format:     "V2",
		FieldNames: []string{"type", "val"},
	}
	packets["07E6"] = common.PacketConstruction{
		ID:         "07E6",
		Name:       "captcha_session_ID",
		Format:     "v V",
		FieldNames: []string{"ID", "generation_time"},
	}
	packets["07E8"] = common.PacketConstruction{
		ID:         "07E8",
		Name:       "captcha_image",
		Format:     "v a*",
		FieldNames: []string{"len", "image"},
	}
	packets["07E9"] = common.PacketConstruction{
		ID:         "07E9",
		Name:       "captcha_answer",
		Format:     "v C",
		FieldNames: []string{"code", "flag"},
	}
	packets["07F6"] = common.PacketConstruction{
		ID:         "07F6",
		Name:       "exp",
		Format:     "a4 V v2",
		FieldNames: []string{"ID", "val", "type", "flag"},
	}
	packets["07F7"] = common.PacketConstruction{
		ID:         "07F7",
		Name:       "actor_exists",
		Format:     "v C a4 v3 V v5 a4 v5 a4 a2 v V C2 a6 C2 v2 Z*",
		FieldNames: []string{"len", "object_type", "ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tick", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "xSize", "ySize", "lv", "font", "name"},
	}
	packets["07F8"] = common.PacketConstruction{
		ID:         "07F8",
		Name:       "actor_connected",
		Format:     "v C a4 v3 V v10 a4 a2 v V C2 a3 C2 v2 Z*",
		FieldNames: []string{"len", "object_type", "ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "xSize", "ySize", "lv", "font", "name"},
	}
	packets["07F9"] = common.PacketConstruction{
		ID:         "07F9",
		Name:       "actor_moved",
		Format:     "v C a4 v3 V v10 a4 a2 v V C2 a3 C3 v2 Z*",
		FieldNames: []string{"len", "object_type", "ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "xSize", "ySize", "act", "lv", "font", "name"},
	}
	packets["07FA"] = common.PacketConstruction{
		ID:         "07FA",
		Name:       "inventory_item_removed",
		Format:     "v a2 v",
		FieldNames: []string{"reason", "ID", "amount"},
	}
	packets["07FB"] = common.PacketConstruction{
		ID:         "07FB",
		Name:       "skill_cast",
		Format:     "a4 a4 v5 V C",
		FieldNames: []string{"sourceID", "targetID", "x", "y", "skillID", "unknown", "type", "wait", "dispose"},
	}
	packets["07FC"] = common.PacketConstruction{
		ID:         "07FC",
		Name:       "party_leader",
		Format:     "V2",
		FieldNames: []string{"old", "new"},
	}
	packets["07FD"] = common.PacketConstruction{
		ID:         "07FD",
		Name:       "special_item_obtain",
		Format:     "v C v c/Z a*",
		FieldNames: []string{"len", "type", "nameID", "holder", "etc"},
	}
	packets["07FE"] = common.PacketConstruction{
		ID:         "07FE",
		Name:       "sound_effect",
		Format:     "Z24",
		FieldNames: []string{"name"},
	}
	packets["07FF"] = common.PacketConstruction{
		ID:         "07FF",
		Name:       "define_check",
		Format:     "v V",
		FieldNames: []string{"len", "result"},
	}
	packets["0800"] = common.PacketConstruction{
		ID:         "0800",
		Name:       "vender_items_list",
		Format:     "v a4 a4 a*",
		FieldNames: []string{"len", "venderID", "venderCID", "itemList"},
	}
	packets["0803"] = common.PacketConstruction{
		ID:         "0803",
		Name:       "booking_register_request",
		Format:     "v",
		FieldNames: []string{"result"},
	}
	packets["0805"] = common.PacketConstruction{
		ID:         "0805",
		Name:       "booking_search_request",
		Format:     "x2 a a*",
		FieldNames: []string{"IsExistMoreResult", "innerData"},
	}
	packets["0807"] = common.PacketConstruction{
		ID:         "0807",
		Name:       "booking_delete_request",
		Format:     "v",
		FieldNames: []string{"result"},
	}
	packets["0809"] = common.PacketConstruction{
		ID:         "0809",
		Name:       "booking_insert",
		Format:     "V Z24 V v8",
		FieldNames: []string{"index", "name", "expire", "lvl", "map_id", "job1", "job2", "job3", "job4", "job5", "job6"},
	}
	packets["080A"] = common.PacketConstruction{
		ID:         "080A",
		Name:       "booking_update",
		Format:     "V v6",
		FieldNames: []string{"index", "job1", "job2", "job3", "job4", "job5", "job6"},
	}
	packets["080B"] = common.PacketConstruction{
		ID:         "080B",
		Name:       "booking_delete",
		Format:     "V",
		FieldNames: []string{"index"},
	}
	packets["080E"] = common.PacketConstruction{
		ID:         "080E",
		Name:       "party_hp_info",
		Format:     "a4 V2",
		FieldNames: []string{"ID", "hp", "hp_max"},
	}
	packets["080F"] = common.PacketConstruction{
		ID:         "080F",
		Name:       "deal_add_other",
		Format:     "v C V C3 a8",
		FieldNames: []string{"nameID", "type", "amount", "identified", "broken", "upgrade", "cards"},
	}
	packets["0810"] = common.PacketConstruction{
		ID:         "0810",
		Name:       "open_buying_store",
		Format:     "c",
		FieldNames: []string{"amount"},
	}
	packets["0812"] = common.PacketConstruction{
		ID:         "0812",
		Name:       "open_buying_store_fail",
		Format:     "v",
		FieldNames: []string{"result"},
	}
	packets["0813"] = common.PacketConstruction{
		ID:         "0813",
		Name:       "open_buying_store_item_list",
		Format:     "v a4 V",
		FieldNames: []string{"len", "AID", "zeny"},
	}
	packets["0814"] = common.PacketConstruction{
		ID:         "0814",
		Name:       "buying_store_found",
		Format:     "a4 Z*",
		FieldNames: []string{"ID", "title"},
	}
	packets["0816"] = common.PacketConstruction{
		ID:         "0816",
		Name:       "buying_store_lost",
		Format:     "a4",
		FieldNames: []string{"ID"},
	}
	packets["0818"] = common.PacketConstruction{
		ID:         "0818",
		Name:       "buying_store_items_list",
		Format:     "v a4 a4 V a*",
		FieldNames: []string{"len", "buyerID", "buyingStoreID", "zeny", "itemList"},
	}
	packets["081A"] = common.PacketConstruction{
		ID:         "081A",
		Name:       "buying_buy_fail",
		Format:     "v",
		FieldNames: []string{"result"},
	}
	packets["081B"] = common.PacketConstruction{
		ID:         "081B",
		Name:       "buying_store_update",
		Format:     "v2 V",
		FieldNames: []string{"itemID", "count", "zeny"},
	}
	packets["081C"] = common.PacketConstruction{
		ID:         "081C",
		Name:       "buying_store_item_delete",
		Format:     "a2 v V",
		FieldNames: []string{"ID", "amount", "zeny"},
	}
	packets["081D"] = common.PacketConstruction{
		ID:         "081D",
		Name:       "elemental_info",
		Format:     "a4 V4",
		FieldNames: []string{"ID", "hp", "hp_max", "sp", "sp_max"},
	}
	packets["081E"] = common.PacketConstruction{
		ID:         "081E",
		Name:       "stat_info",
		Format:     "v V",
		FieldNames: []string{"type", "val"},
	}
	packets["0824"] = common.PacketConstruction{
		ID:         "0824",
		Name:       "buying_store_fail",
		Format:     "v2",
		FieldNames: []string{"result", "itemID"},
	}
	packets["0828"] = common.PacketConstruction{
		ID:         "0828",
		Name:       "char_delete2_result",
		Format:     "a4 V2",
		FieldNames: []string{"charID", "result", "deleteDate"},
	}
	packets["082A"] = common.PacketConstruction{
		ID:         "082A",
		Name:       "char_delete2_accept_result",
		Format:     "V V",
		FieldNames: []string{"charID", "result"},
	}
	packets["082C"] = common.PacketConstruction{
		ID:         "082C",
		Name:       "char_delete2_cancel_result",
		Format:     "a4 V",
		FieldNames: []string{"charID", "result"},
	}
	packets["082D"] = common.PacketConstruction{
		ID:         "082D",
		Name:       "received_characters_info",
		Format:     "v C5 x20",
		FieldNames: []string{"len", "normal_slot", "premium_slot", "billing_slot", "producible_slot", "valid_slot"},
	}
	packets["0836"] = common.PacketConstruction{
		ID:         "0836",
		Name:       "search_store_result",
		Format:     "v C3 a*",
		FieldNames: []string{"len", "first_page", "has_next", "remaining", "storeInfo"},
	}
	packets["0837"] = common.PacketConstruction{
		ID:         "0837",
		Name:       "search_store_fail",
		Format:     "C",
		FieldNames: []string{"reason"},
	}
	packets["0839"] = common.PacketConstruction{
		ID:         "0839",
		Name:       "guild_expulsion",
		Format:     "Z24 Z40",
		FieldNames: []string{"name", "message"},
	}
	packets["083A"] = common.PacketConstruction{
		ID:         "083A",
		Name:       "search_store_open",
		Format:     "v C",
		FieldNames: []string{"type", "amount"},
	}
	packets["083D"] = common.PacketConstruction{
		ID:         "083D",
		Name:       "search_store_pos",
		Format:     "v v",
		FieldNames: []string{"x", "y"},
	}
	packets["083E"] = common.PacketConstruction{
		ID:         "083E",
		Name:       "login_error",
		Format:     "V Z20",
		FieldNames: []string{"type", "date"},
	}
	packets["0845"] = common.PacketConstruction{
		ID:         "0845",
		Name:       "cash_shop_open_result",
		Format:     "V2",
		FieldNames: []string{"cash_points", "kafra_points"},
	}
	packets["0849"] = common.PacketConstruction{
		ID:         "0849",
		Name:       "cash_shop_buy_result",
		Format:     "V s V",
		FieldNames: []string{"item_id", "result", "updated_points"},
	}
	packets["084B"] = common.PacketConstruction{
		ID:         "084B",
		Name:       "item_appeared",
		Format:     "a4 v2 C v2 C2 v",
		FieldNames: []string{"ID", "nameID", "type", "identified", "x", "y", "subx", "suby", "amount"},
	}
	packets["0856"] = common.PacketConstruction{
		ID:         "0856",
		Name:       "actor_moved",
		Format:     "v C a4 v3 V v5 a4 v6 a4 a2 v V C2 a6 C2 v2 Z*",
		FieldNames: []string{"len", "object_type", "ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tick", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "costume", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "xSize", "ySize", "lv", "font", "name"},
	}
	packets["0857"] = common.PacketConstruction{
		ID:         "0857",
		Name:       "actor_exists",
		Format:     "v C a4 v3 V v11 a4 a2 v V C2 a3 C3 v2 Z*",
		FieldNames: []string{"len", "object_type", "ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "costume", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "xSize", "ySize", "act", "lv", "font", "name"},
	}
	packets["0858"] = common.PacketConstruction{
		ID:         "0858",
		Name:       "actor_connected",
		Format:     "v C a4 v3 V v11 a4 a2 v V C2 a3 C2 v2 Z*",
		FieldNames: []string{"len", "object_type", "ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "costume", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "xSize", "ySize", "lv", "font", "name"},
	}
	packets["0859"] = common.PacketConstruction{
		ID:         "0859",
		Name:       "show_eq",
	...
	packets["08B3"] = common.PacketConstruction{
		ID:         "08B3",
		Name:       "show_script",
		Format:     "v a4 Z*",
		FieldNames: []string{"len", "ID", "message"},
	}
	packets["08B4"] = common.PacketConstruction{
		ID:         "08B4",
		Name:       "pet_capture_process",
		Format:     "",
		FieldNames: []string{},
	}
	packets["08B6"] = common.PacketConstruction{
		ID:         "08B6",
		Name:       "pet_capture_result",
		Format:     "C",
		FieldNames: []string{"success"},
	}
	packets["08B9"] = common.PacketConstruction{
		ID:         "08B9",
		Name:       "login_pin_code_request",
		Format:     "V a4 v",
		FieldNames: []string{"seed", "accountID", "flag"},
	}
	packets["08BB"] = common.PacketConstruction{
		ID:         "08BB",
		Name:       "login_pin_new_code_result",
		Format:     "v V",
		FieldNames: []string{"flag", "seed"},
	}
	packets["08C7"] = common.PacketConstruction{
		ID:         "08C7",
		Name:       "area_spell",
		Format:     "x2 a4 a4 v2 C3",
		FieldNames: []string{"ID", "sourceID", "x", "y", "type", "range", "isVisible"},
	}
	packets["08C8"] = common.PacketConstruction{
		ID:         "08C8",
		Name:       "actor_action",
		Format:     "a4 a4 a4 V3 x v C V",
		FieldNames: []string{"sourceID", "targetID", "tick", "src_speed", "dst_speed", "damage", "div", "type", "dual_wield_damage"},
	}
	packets["08CA"] = common.PacketConstruction{
		ID:         "08CA",
		Name:       "cash_shop_list",
		Format:     "v3 a*",
		FieldNames: []string{"len", "amount", "tabcode", "itemInfo"},
	}
	packets["08CB"] = common.PacketConstruction{
		ID:         "08CB",
		Name:       "rates_info",
		Format:     "s4 a*",
		FieldNames: []string{"len", "exp", "death", "drop", "detail"},
	}
	packets["08CD"] = common.PacketConstruction{
		ID:         "08CD",
		Name:       "actor_movement_interrupted",
		Format:     "a4 v2",
		FieldNames: []string{"ID", "x", "y"},
	}
	packets["08CF"] = common.PacketConstruction{
		ID:         "08CF",
		Name:       "revolving_entity",
		Format:     "a4 v v",
		FieldNames: []string{"sourceID", "type", "entity"},
	}
	packets["08D2"] = common.PacketConstruction{
		ID:         "08D2",
		Name:       "high_jump",
		Format:     "a4 v2",
		FieldNames: []string{"ID", "x", "y"},
	}
	packets["08E2"] = common.PacketConstruction{
		ID:         "08E2",
		Name:       "navigate_to",
		Format:     "C3 Z16 v3",
		FieldNames: []string{"type", "flag", "hide_window", "map", "x", "y", "mob_id"},
	}
	packets["08FE"] = common.PacketConstruction{
		ID:         "08FE",
		Name:       "quest_update_mission_hunt",
		Format:     "v a*",
		FieldNames: []string{"len", "message"},
	}
	packets["08FF"] = common.PacketConstruction{
		ID:         "08FF",
		Name:       "actor_status_active",
		Format:     "a4 v V4",
		FieldNames: []string{"ID", "type", "tick", "unknown1", "unknown2", "unknown3"},
	}
	packets["0900"] = common.PacketConstruction{
		ID:         "0900",
		Name:       "inventory_items_stackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["0901"] = common.PacketConstruction{
		ID:         "0901",
		Name:       "inventory_items_nonstackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["0902"] = common.PacketConstruction{
		ID:         "0902",
		Name:       "cart_items_stackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["0903"] = common.PacketConstruction{
		ID:         "0903",
		Name:       "cart_items_nonstackable",
		Format:     "v a*",
		FieldNames: []string{"len", "itemInfo"},
	}
	packets["0906"] = common.PacketConstruction{
		ID:         "0906",
		Name:       "show_eq",
		Format:     "v Z24 x17 a*",
		FieldNames: []string{"len", "name", "equips_info"},
	}
	packets["0908"] = common.PacketConstruction{
		ID:         "0908",
		Name:       "inventory_item_favorite",
		Format:     "a2 C",
		FieldNames: []string{"ID", "flag"},
	}
	packets["090F"] = common.PacketConstruction{
		ID:         "090F",
		Name:       "actor_connected",
		Format:     "v C a4 v3 V v11 a4 a2 v V C2 a3 C2 v2 V2 C v Z*",
		FieldNames: []string{"len", "object_type", "ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "costume", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "xSize", "ySize", "lv", "font", "maxHP", "HP", "isBoss", "body_style", "name"},
	}
	packets["0914"] = common.PacketConstruction{
		ID:         "0914",
		Name:       "actor_moved",
		Format:     "v C a4 v3 V v5 a4 v6 a4 a2 v V C2 a6 C2 v2 V2 C v Z*",
		FieldNames: []string{"len", "object_type", "ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tick", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "costume", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "xSize", "ySize", "lv", "font", "maxHP", "HP", "isBoss", "body_style", "name"},
	}
	packets["0915"] = common.PacketConstruction{
		ID:         "0915",
		Name:       "actor_exists",
		Format:     "v C a4 v3 V v11 a4 a2 v V C2 a3 C3 v2 V2 C v Z*",
		FieldNames: []string{"len", "object_type", "ID", "walk_speed", "opt1", "opt2", "option", "type", "hair_style", "weapon", "shield", "lowhead", "tophead", "midhead", "hair_color", "clothes_color", "head_dir", "costume", "guildID", "emblemID", "manner", "opt3", "stance", "sex", "coords", "xSize", "ySize", "act", "lv", "font", "maxHP", "HP", "isBoss", "body_style", "name"},
	}
