...
// ServerType05PacketConstructions provides packet constructions for ServerType0.5
func ServerType05PacketConstructions() map[string]common.PacketConstruction {
	...
	packets["00CD"] = common.PacketConstruction{
		ID:         "00CD",
		Name:       "gm_kick_all",
		Format:     "",
		FieldNames: []string{},
	...
	packets["01BE"] = common.PacketConstruction{
		ID:         "01BE",
		Name:       "gm_remove",
		Format:     "Z24",
		FieldNames: []string{"playerName"},
	...
	packets["02A5"] = common.PacketConstruction{
		ID:         "02A5",
		Name:       "companion_release",
		Format:     "",
		FieldNames: []string{},
	...
	packets["036A"] = common.PacketConstruction{
		ID:         "036A",
		Name:       "auction_buy",
		Format:     "a4 V",
		FieldNames: []string{"ID", "price"},
	}
	packets["036B"] = common.PacketConstruction{
		ID:         "036B",
		Name:       "auction_search",
		Format:     "C V a24 v",
		FieldNames: []string{"type", "price", "search_string", "page"},
	}
	packets["036C"] = common.PacketConstruction{
		ID:         "036C",
		Name:       "auction_info_self",
		Format:     "C",
		FieldNames: []string{"type"},
	}
	packets["036D"] = common.PacketConstruction{
		ID:         "036D",
		Name:       "auction_sell_stop",
		Format:     "a4",
		FieldNames: []string{"ID"},
	...
	packets["0448"] = common.PacketConstruction{
		ID:         "0448",
	...
	packets["07E5"] = common.PacketConstruction{
		ID:         "07E5",
	...
	packets["0848"] = common.PacketConstruction{
		ID:         "0848",
		Name:       "cash_shop_buy",
		Format:     "V v a*",
		FieldNames: []string{"kafra_points", "count", "buy_info"},
	}
	packets["0871"] = common.PacketConstruction{
		ID:         "0871",
		Name:       "macro_start",
		Format:     "",
		FieldNames: []string{},
	}
	packets["0872"] = common.PacketConstruction{
		ID:         "0872",
		Name:       "macro_stop",
		Format:     "",
		FieldNames: []string{},
	...
	packets["0972"] = common.PacketConstruction{
		ID:         "0972",
	...
	packets["09A4"] = common.PacketConstruction{
		ID:         "09A4",
		Name:       "item_list_window_selected",
		Format:     "v C C a*",
		FieldNames: []string{"len", "type", "act", "itemInfo"},
	...
	packets["0A90"] = common.PacketConstruction{
		ID:         "0A90",
	...
	packets["0AA1"] = common.PacketConstruction{
		ID:         "0AA1",
	...
	packets["0AA3"] = common.PacketConstruction{
		ID:         "0AA3",
		Name:       "refineui_refine",
		Format:     "v v C",
		FieldNames: []string{"index", "catalyst", "bless"},
	}
	packets["0AA4"] = common.PacketConstruction{
		ID:         "0AA4",
		Name:       "refineui_close",
		Format:     "",
		FieldNames: []string{},
	...
	packets["0B01"] = common.PacketConstruction{
		ID:         "0B01",
		Name:       "clan_chat",
		Format:     "v Z*",
		FieldNames: []string{"len", "message"},
	...
	packets["0B0D"] = common.PacketConstruction{
		ID:         "0B0D",
		Name:       "starplace_agree",
		Format:     "C",
		FieldNames: []string{"flag"},
